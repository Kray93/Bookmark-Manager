...
function start(tabs) {
    ...
    function addLinks() {
        for (var i = 0, l = links.length; i < l; i++) {
            ...
            link.css({
                background: () => { return $(this).data("color") },
    ...
    function styleLinks() {
        for (var i = 0, l = links.length; i < l; i++) {
            ...
            setTransformOrigin({
                link: "0px " + linkSize * 0.5 + "px",
                hover: "0px " + linkSize * 0.5 + "px"
            });
            setTransition({
                link: "all 0.2s ease-out",
                hover: "all 0.2s ease-out"
            });
            setTransform({
                link: "rotate(" + deg + "deg)",
                hover: "rotate(" + deg + "deg)"
            });
            hover.css({
    ...
    function linkOver(e) {
        ...
        body.css("backgroundColor", thisLink.dataset.color)
    }
